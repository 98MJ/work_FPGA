...
HD_PWD='D:/work_FPGA/20240520_UART/20240520_UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_tx_rx_loop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_tx_rx_loop.tcl -notrace
