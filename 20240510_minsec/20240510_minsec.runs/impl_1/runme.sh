...
HD_PWD='D:/work_FPGA/20240510_minsec/20240510_minsec.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log minsec_clock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source minsec_clock.tcl -notrace
