...
HD_PWD='D:/work_FPGA/20240514_LedButton/20240514_LedButton.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_toggle.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_toggle.tcl
