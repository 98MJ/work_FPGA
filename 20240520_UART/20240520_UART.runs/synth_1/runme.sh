...
HD_PWD='D:/work_FPGA/20240520_UART/20240520_UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_tx_rx_loop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_tx_rx_loop.tcl
