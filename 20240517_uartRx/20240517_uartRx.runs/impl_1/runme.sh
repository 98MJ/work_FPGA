...
HD_PWD='D:/work_FPGA/20240517_uartRx/20240517_uartRx.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UartRx.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UartRx.tcl -notrace
