...
HD_PWD='D:/work_FPGA/20240510_minsec/20240510_minsec.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log minsec_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source minsec_clock.tcl
