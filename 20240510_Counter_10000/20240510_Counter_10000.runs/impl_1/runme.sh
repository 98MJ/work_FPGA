...
HD_PWD='D:/work_FPGA/20240510_Counter_10000/20240510_Counter_10000.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Count_disp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Count_disp.tcl -notrace
