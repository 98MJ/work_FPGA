...
HD_PWD='D:/work_FPGA/20240513_ClockCounter/20240513_ClockCounter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ClockCounter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ClockCounter.tcl -notrace
