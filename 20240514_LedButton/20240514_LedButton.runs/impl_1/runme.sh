...
HD_PWD='D:/work_FPGA/20240514_LedButton/20240514_LedButton.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_toggle.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_toggle.tcl -notrace
