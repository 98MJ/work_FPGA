...
HD_PWD='D:/work_FPGA/20240517_uartRx/20240517_uartRx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UartRx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UartRx.tcl
