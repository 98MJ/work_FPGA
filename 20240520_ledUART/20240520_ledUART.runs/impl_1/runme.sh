...
HD_PWD='D:/work_FPGA/20240520_ledUART/20240520_ledUART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_led.tcl -notrace
