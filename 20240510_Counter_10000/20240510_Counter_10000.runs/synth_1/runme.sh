...
HD_PWD='D:/work_FPGA/20240510_Counter_10000/20240510_Counter_10000.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Count_disp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Count_disp.tcl
