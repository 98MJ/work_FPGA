...
HD_PWD='D:/work_FPGA/20240513_ClockCounter/20240513_ClockCounter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ClockCounter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ClockCounter.tcl
